...
const { add_to_cart, get_cart_items, increment_quantity, decrement_quantity, delete_item, productsController } = require("../controllers/cartController");
const cart_route = express.Router();

cart_route.post("/place-order",add_to_cart);
